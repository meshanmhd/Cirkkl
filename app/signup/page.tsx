  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-white">
      ...
      <div className="relative hidden bg-gradient-to-br from-white to-[#cfe467]/20 lg:flex flex-col items-center justify-center p-0 overflow-hidden">
        <img src="/treasure.svg" alt="Treasure" className="max-w-md w-full h-auto drop-shadow-2xl z-10" />
        
        {/* Decorative background elements behind image */}
        <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-[#cfe467]/30 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-72 h-72 bg-[#FF3B7A]/20 rounded-full blur-3xl" />
      </div>
    </div>
  );
}
